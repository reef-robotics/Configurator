...
# zip file created Tue Dec 19 15:39:56 CST 2017
#
...
select x in "ATLaS only" "Z-Puck only" "Both" "Swap Parallel Ports" "None";
do
	case $x in
		"ATLaS only" )
			SENSOR="ATLAS";
...
echo "PENDANT     =" $GAMEPAD >> .CONFIGS/CONFIG_DUMP-.$ORDER_NO
